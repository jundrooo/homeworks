...
#usage
sonlar  = [1,4,8,3,7] # sonlar nomli parametrga ushbu ro'yxat yuklanadi
print('eng katta son: ',katta_sonni_top(sonlar)) # hamda print() yordamida funksiyaga murojat qilib sonlar ekranga chiqariladi
...
#usage
list1 = ['matn','matn2','matn3'] # list1 ga argument sifatida ushbu list uzatiladi
print(textCapitalize(list1)) # print() yordamia ushbu metod ekranga chiqariladi
